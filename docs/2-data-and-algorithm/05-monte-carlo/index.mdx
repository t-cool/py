...
モンテカルロ法を用いてコイン投げで表が出る確率を求めてみましょう。表が出る確率が $1/2$ なのは、すでに知っていると思いますが、モンテカルロ法の練習としてみてみましょう。
...
扇形上の面積は、$\frac{1}{2} r^2 \frac{\pi}{2}$ なので、扇形の上に点が乗る確率は、$\frac{1}{2} r^2 \frac{\pi}{2} = \frac{\pi}{4}$ となります。
